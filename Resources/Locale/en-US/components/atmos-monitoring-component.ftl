...
atmos-monitoring-window-tab-no-alerts = Alerts
atmos-monitoring-window-tab-alerts = Alerts ({$value})
atmos-monitoring-window-tab-air-alarms = Air alarms
atmos-monitoring-window-tab-fire-alarms = Fire alarms
...
atmos-monitoring-window-alarm-label = {CAPITALIZE($name)} ({$address})
...
atmos-monitoring-window-silence-alerts = Silence alerts from this alarm
...
atmos-monitoring-window-show-inactive-alarms = Inactive alarms

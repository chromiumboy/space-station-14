...
atmos-alerts-window-toggle-overlays = Toggle alarm overlays
atmos-alerts-window-show-inactive-alarms = Inactive alarms

atmos-alerts-window-flavor-left = Contact an atmospheric technician for assistance
atmos-alerts-window-flavor-right = v0.8
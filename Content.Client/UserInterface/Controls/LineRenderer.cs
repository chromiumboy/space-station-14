...
/// <summary>
/// A simple control that contains a list of lines to render 
/// </summary>
public sealed class LineRenderer : Control
{
    /// <summary>
    /// List of lines to render (their start and end x-y coordinates) -
    /// position (0,0) is the top left corner of the control,
    /// position (1,1) is the bottom right corner.
    /// The color of the line is dependent on the color of the control.
    /// </summary>

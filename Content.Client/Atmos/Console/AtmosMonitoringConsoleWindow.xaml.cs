...
public sealed partial class AtmosMonitoringConsoleWindow : FancyWindow
{
    ...
    private void AddTrackedEntityToNavMap(AtmosMonitorData metaData, AtmosAlarmEntry[] activeAlarms)
    {
    ...
    private void MakeNewAlarmEntry(AtmosAlarmEntry entry, AtmosMonitoringConsoleComponent console, AtmosMonitorFocusDeviceData? focusData = null)
    {

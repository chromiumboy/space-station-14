...
public sealed partial class AtmosMonitoringConsoleWindow : FancyWindow
{
    ...
    private void MakeNewAlarmEntry(AtmosAlarmEntry entry, AtmosMonitorFocusDeviceData? focusData = null)
    {
        ...
        if (focusData?.NetEntity == entry.Entity)
        {
            ...
            var tempC = MathF.Ceiling(tempK - 273.15f);
            ...
            var missing1 = new Label()
            {
                Text = "Nitrogen [3 mol (15%)]",
                HorizontalAlignment = HAlignment.Center,
                VerticalAlignment = VAlignment.Center,
                HorizontalExpand = true,
                FontColorOverride = StyleNano.ConcerningOrangeFore,
    ...
    private Color DetermineAlertColoration(Shared.Atmos.Monitor.AtmosAlarmType alarmType)
    {
        switch (alarmType)
        {
            case Shared.Atmos.Monitor.AtmosAlarmType.Normal:
                return StyleNano.GoodGreenFore;
            case Shared.Atmos.Monitor.AtmosAlarmType.Warning:
                return StyleNano.ConcerningOrangeFore;
            case Shared.Atmos.Monitor.AtmosAlarmType.Danger:
